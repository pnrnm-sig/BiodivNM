...
def getListOrganismINSEE(connection, insee):
    # Fiche espèce : Liste des organismes pour une commune
    sql = """select 
            nb_observations, id_organism, nom_organism, url_organism, url_logo, insee 
            from atlas.vm_cor_communes_organism 
...
def getGroupeOrganisms(connection, groupe):
    sql = """
