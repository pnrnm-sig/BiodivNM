...
class MapConfig(Schema):
    ...
    BORDERS_COLOR_VP = fields.String(missing="#000000")
    BORDERS_WEIGHT_VP = fields.Integer(missing=1)
    ...
    STATIC_PAGES = fields.Dict(
        load_default={
            ...
            "donnees": {
                ...
                "picto": "fa fa-cog",
                "order": 1,
                "template": "static/custom/templates/donnees.html",
            },
            "partenaires": {
                "title": "Partenaires",
                "picto": "fa fa-handshake",
                "order": 2,
                "template": "static/custom/templates/partenaires.html",
            }
        }
    )
