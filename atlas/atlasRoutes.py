...
def ficheEspece(cd_nom):
    ...
    synovern = vmTaxrefRepository.getSynonymyVern(connection, cd_ref)
...
def ficheCommune(insee):
    ...
    organisms = vmOrganismsRepository.getListOrganismINSEE(connection, insee)
...
def ficheGroupe(groupe):
    ...
    organisms = vmOrganismsRepository.getGroupeOrganisms(connection, groupe)
