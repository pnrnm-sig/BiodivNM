...
if ! database_exists $db_name
    then
        ...
        if $use_ref_geo_gn2
            ...
            ogr2ogr -f "ESRI Shapefile" -t_srs EPSG:4326 data/ref/emprise_territoire_4326.shp $limit_shp_limites
            sudo -n -u postgres -s shp2pgsql -W "LATIN1" -s 4326 -D -I ./data/ref/emprise_territoire_4326.shp atlas.t_layer_territoire_limites | sudo -n -u postgres -s psql -d $db_name  &>> log/install_db.log
            rm data/ref/emprise_territoire_4326.*
            ...
            ogr2ogr -f "ESRI Shapefile" -t_srs EPSG:4326 data/ref/emprise_territoire_4326.shp $limit_shp_ajoutvp
            sudo -n -u postgres -s shp2pgsql -W "LATIN1" -s 4326 -D -I ./data/ref/emprise_territoire_4326.shp atlas.t_layer_territoire_vp | sudo -n -u postgres -s psql -d $db_name  &>> log/install_db.log
            rm data/ref/emprise_territoire_4326.*
        ...
        rm  -f ./atlas/static/custom/territoire_vp.json
        ogr2ogr -f "GeoJSON" -t_srs "EPSG:4326" -s_srs "EPSG:4326" ./atlas/static/custom/territoire_vp.json \
