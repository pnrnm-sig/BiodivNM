...
pip install --force-reinstall -v "flask-babel==2.0.0"
pip install --force-reinstall -v "flask-caching==1.10.1"
pip install --force-reinstall -v "flask-compress==1.10.1"
pip install --force-reinstall -v "flask-script==2.0.6"
pip install --force-reinstall -v "flask-sqlalchemy==2.5.1"
pip install --force-reinstall -v "babel==2.9.1"
pip install --force-reinstall -v "brotli==1.0.9"
pip install --force-reinstall -v "dominate==2.6.0"
pip install --force-reinstall -v "geoalchemy2==0.9.4"
pip install --force-reinstall -v "geojson==2.5.0"
pip install --force-reinstall -v "gunicorn==20.1.0"
pip install --force-reinstall -v "marshmallow==3.14.1"
pip install --force-reinstall -v "packaging==21.3"
pip install --force-reinstall -v "psycopg2==2.9.2"
pip install --force-reinstall -v "pyparsing==3.0.6"
pip install --force-reinstall -v "pytz==2021.3"
pip install --force-reinstall -v "sqlalchemy==1.4.27"
pip install --force-reinstall -v "visitor==0.1.3"
pip install --force-reinstall -v "flask==2.2.5"
pip install --force-reinstall -v "werkzeug==2.2.3"
pip install --force-reinstall -v "greenlet==1.1.3"
pip install --force-reinstall -v "click==8.1.3"
pip install --force-reinstall -v "itsdangerous==2.1.2"
pip install --force-reinstall -v "jinja2==3.1.2"
pip install --force-reinstall -v "markupsafe==2.1.1"
